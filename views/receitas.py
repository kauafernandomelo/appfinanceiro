...
class ReceitasView(ctk.CTkFrame):
    ...
    def _criar_header(self):
        ...
        ctk.CTkLabel(header, text="Receitas", font=ctk.CTkFont(size=28, weight="bold"),
        ...
        ctk.CTkLabel(header, text=f"Total: {formatar_moeda(total)}",
                      ...
                      text_color=self.colors.get("green", "#00b894")).pack(side="right")
    ...
    def _criar_formulario(self):
        ...
        self.entry_desc = ctk.CTkEntry(g, placeholder_text="Ex: Salario, Freelance...",
    ...
    def _atualizar(self):
        ...
        for i, r in enumerate(rows):
            ...
            ctk.CTkButton(row, text="X", width=30, height=28, corner_radius=6,
                           ...
                           command=lambda rid=r["id"]: self._excluir(rid)).grid(row=0, column=4, padx=10, pady=8)

    def _excluir(self, rid):
        modal = ConfirmarExclusaoModal(self, "Excluir Receita", "Deseja excluir esta receita?", colors=self.colors)
