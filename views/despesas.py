    ...
    def _atualizar(self):
        ...
        for i, r in enumerate(rows):
            ...
            ctk.CTkButton(row, text="E", width=28, height=28, corner_radius=6,
                           ...
                           command=lambda did=r["id"]: self._editar(did)).grid(row=0, column=4, padx=(10, 4), pady=8)
            ctk.CTkButton(row, text="X", width=28, height=28, corner_radius=6,
                           font=ctk.CTkFont(size=11, weight="bold"),
                           fg_color=self.colors.get("red", "#d63031"), hover_color="#c0392b",
                           command=lambda did=r["id"]: self._excluir(did)).grid(row=0, column=5, padx=(4, 10), pady=8)
